...
"")
        ...
        self.treeWidget.headerItem().setText(0, "Column 0 (Key)")
        self.treeWidget.headerItem().setText(1, "Column 1 (func0)")
        self.treeWidget.headerItem().setText(2, "Column 2 (func1)")
        ...
        for root_key, root_value in d.items():
            root_item = QtWidgets.QTreeWidgetItem(self.treeWidget)
